...
export function CtaSection({
  ...
  return (
    <Section glass className="pb-20 sm:pb-24">
      <Reveal>
        <div className="glass-section border-beam relative overflow-hidden rounded-[var(--radius-section)] px-6 py-14 text-center sm:px-12 sm:py-20">
          <div className="absolute inset-0 bg-inverse/92 backdrop-blur-2xl" />
          ...
          <div className="relative mx-auto flex max-w-2xl flex-col items-center gap-5">
            ...
            <p className="text-base leading-relaxed text-inverse-fg/70 sm:text-lg">
              {description}
            </p>
            <div className="mt-2 flex flex-col items-center gap-3 sm:flex-row">
              ...
              <a
                ...
                className="text-sm font-semibold text-inverse-fg/60 transition-colors hover:text-accent"
              >
