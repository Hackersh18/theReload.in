...
export function ServiceCard({
  ...
  const cardClass = cn(
    "group relative flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition-all duration-300 hover:border-accent/30 hover:bg-white/[0.05] sm:p-6",
    "hover-3d-lift",
    className,
  );
